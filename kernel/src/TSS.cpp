...
void InitializeTSS()
{
    ...
    gdt.entries[5].base0 = (uint64_t)tss;
    gdt.entries[5].base1 = (uint64_t)tss >> 16;
    gdt.entries[5].base2 = (uint64_t)tss >> 24;
    gdt.entries[5].limit0 = sizeof(TSS) - 1;
    gdt.entries[5].limit1Attributes = 0b0'0'0'0'0000 | ((sizeof(TSS) - 1) >> 16);
    gdt.entries[5].typeAttributes = 0b1'00'0'1001;
    *(uint64_t*)&gdt.entries[6] = (uint64_t)tss >> 32;

    asm volatile("ltr %0" : : "r"((uint16_t)0b101'000));
